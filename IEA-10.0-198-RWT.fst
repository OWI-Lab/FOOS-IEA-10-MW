...
---------------------- INPUT FILES ---------------------------------------------
"01_ElastoDyn/IEA-10.0-198-RWT_ElastoDyn.dat" EDFile                    - Name of file containing ElastoDyn input parameters (quoted string)
...
"06_SeaState/IEA-10.0-198-RWT_SeaState.dat" SeaStFile                   - Name of file containing sea state input parameters (quoted string)
