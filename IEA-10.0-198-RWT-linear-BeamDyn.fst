...
23.35                  WtrDpth     - Water depth (m)
0                      MSL2SWL     - Offset between still-water level and mean sea level (m) [positive upward]
---------------------- INPUT FILES ---------------------------------------------
"01_ElastoDyn/IEA-10.0-198-RWT_ElastoDyn_linear.dat" EDFile                    - Name of file containing ElastoDyn input parameters (quoted string)
"02_BeamDyn/IEA-10.0-198-RWT_BeamDyn.dat"  BDBldFile(1)                            - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"02_BeamDyn/IEA-10.0-198-RWT_BeamDyn.dat"  BDBldFile(2)                            - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"02_BeamDyn/IEA-10.0-198-RWT_BeamDyn.dat"  BDBldFile(3)                            - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"03_InflowWind/IEA-10.0-198-RWT_InflowFile.dat" InflowFile                            - Name of file containing inflow wind input parameters (quoted string)
"04_AeroDyn/IEA-10.0-198-RWT_AeroDyn15.dat" AeroFile                               - Name of file containing aerodynamic input parameters (quoted string)
"05_ServoDyn/IEA-10.0-198-RWT_ServoDyn.dat" ServoFile                               - Name of file containing control and electrical-drive input parameters (quoted string)
"06_SeaState/IEA-10.0-198-RWT_SeaState_linear.dat" SeaStFile                   - Name of file containing sea state input parameters (quoted string)
"07_HydroDyn/IEA-10.0-198-RWT_HydroDyn.dat" HydroFile                               - Name of file containing hydrodynamic input parameters (quoted string)
"08_SubDyn/owi_IEA-10.0-198-RWT_SubDyn.dat" SubFile                                   - Name of file containing sub-structural input parameters (quoted string)
